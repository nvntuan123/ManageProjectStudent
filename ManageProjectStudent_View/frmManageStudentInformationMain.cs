...
{
    public partial class frmManageStudentInformationMain : Form
    {
        private Button currentButton;
        private Random random;
        private int tempIndex;
        private Form activeForm;
        public frmManageStudentInformationMain()
        {
            InitializeComponent();
            random = new Random();
        ...
        private void btnManageStudentInformation_Click(object sender, EventArgs e)
        {
            OpenChildForm(new ManageProjectStudent_View.frmManageStudentInformation(), sender);
